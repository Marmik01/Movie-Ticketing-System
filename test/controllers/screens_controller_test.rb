...
class ScreensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screen" do
    assert_difference("Screen.count") do
      post screens_url, params: { screen: { capacity: @screen.capacity, name: @screen.name } }
    end
  ...
  test "should update screen" do
    patch screen_url(@screen), params: { screen: { capacity: @screen.capacity, name: @screen.name } }
